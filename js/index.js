...
if (localStorage.getItem("tasks") == null)
 {
  ...
  //to convert it into a string. const myJSON = JSON.stringify(obj)
} 
else
{
...
window.addEventListener("load", () => {
  ...
  // previousElementSibling .....returns the previous element of the specified element, in the same tree level
  const options = document.getElementById("options");
  const optionButtons = [...document.querySelectorAll(".options__button")]; 
  // querySelectorAll.....allows you to retrieve all elements that match the query parameter passed to the method.
